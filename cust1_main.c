      ...
      a[3]=0;
        ...
        {      
          NRF_LOG_INFO("%d",a[i]);
            ...
            nrf_gpio_pin_write(LED_5,a[0]);
            nrf_gpio_pin_write(LED_6,a[1]);
            nrf_gpio_pin_write(LED_7,a[2]);
            nrf_gpio_pin_write(LED_8,a[3]);
    }
    else
    {
...
// Start timers
static void start_timer1(int n)
{
    uint32_t err_code;
      ...
      switch (evt)
      {
       ...
       case BSP_EVENT_KEY_2:  //On Button 4 press - Auto Button
         NRF_LOG_INFO("Timer Started....");
            auto_state=0;
            if(auto_val>0 && prog_state==2){
               nrf_gpio_pin_clear(LED_1);
               nrf_gpio_pin_set(LED_4);
               nrf_gpio_pin_set(LED_10);
               timeout=auto_val-1;
                seven_seg(auto_val);
                start_timer1(60000);
            }
        ...
        case BSP_EVENT_KEY_3:    //On Button 4 press - Program Button

            if(prog_state==2)
            {
                prog_state=0;
                NRF_LOG_INFO("Program off...");
                nrf_gpio_pin_clear(LED_3);
                break;
            }
            else if(prog_state==0 || prog_state==2)
            {
                prog_state=1;
                NRF_LOG_INFO("Program the device now");
            ...
            {
                prog_state=2;
                NRF_LOG_INFO("Auto value set to %d",auto_val);
        ...
        case BSP_EVENT_KEY_4:    //On Button 5 press  
//            NRF_LOG_INFO("Moter1 On");
//            app_timer_stop_all();
//            nrf_gpio_pin_toggle(LED_4);
              
           break;

         case BSP_EVENT_KEY_5:    //On Button 6 press  
//            NRF_LOG_INFO("Moter2 On");
//            nrf_gpio_pin_toggle(LED_10);
           break;
